...
//   height: "auto",
// barHeight: 3,
//   url: "./assets/montSon/Survivants BOB 1/AudioFiles/Stem All.wav",
// });
...
const waveSurvivorsDirects = WaveSurfer.create({
  ...
  barHeight: 1.2,
  barWidth: 1.5,
  url: "./assets/montSon/Survivants BOB 1/AudioFiles/Stem Directs.wav",
});
...
const waveSurvivorsPs = WaveSurfer.create({
  ...
  barHeight: 1.6,
  barWidth: 1.5,
  url: "./assets/montSon/Survivants BOB 1/AudioFiles/Stem Post-Synchros.wav",
});
...
const waveSurvivorsAmb = WaveSurfer.create({
  ...
  barHeight: 5,
  barWidth: 1.5,
  url: "./assets/montSon/Survivants BOB 1/AudioFiles/Stem Ambiances.wav",
});
...
const waveSurvivorsFx = WaveSurfer.create({
  ...
  barHeight: 1.7,
  barWidth: 1.5,
  url: "./assets/montSon/Survivants BOB 1/AudioFiles/Stem Effets.wav",
});
...
const waveSurvivorsFoley = WaveSurfer.create({
  ...
  barHeight: 1.7,
  barWidth: 1.5,
  url: "/assets/montSon/Survivants BOB 1/AudioFiles/Stem Bruitages.wav",
});
...
const waveSurvivorsMusic = WaveSurfer.create({
  ...
  barHeight: 3,
  barWidth: 1.5,
  url: "./assets/montSon/Survivants BOB 1/AudioFiles/Stem Musique.wav",
});
